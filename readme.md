...
### Выводы
- Распараллеливание хорошо помогает - время последовательной программы на большом количестве точек (10^9) 20с, а програма на 10 процессах за 2.5 секунды
- При этом эффективность очень высокая и с увеличением количества точек растет, но стабилизируется на 95% после 10^6 точек.
- Однако, несмотря на то, что 10 процессов отрабатывают быстрее всего, по эффективности они сильно проседают (82.5% против 95% на 5 процессах). Ускорение же все равно получается очень хорошим, что говорит, что 10 процессов - это самый быстрый вариант
...
### Выводы
- По первому графику видно, что все три варианта разбиений работают сильно быстрее, чем последовательный алгоритм. Но среди них есть те, кто работает чуть лучше на 10^8 элементах - самые быстрые, это 10 процессов по строкам, затем 10 процессов по столбцам, затем 5 процессов по строкам, разбиение по блокам явно медленее, чем по строкам и столбцам. По строкам - самое быстрое.
- По второму графику, наша догадка подтверждается и ускорение по блокам явно проигрывает другим двум алгоритмам. По строкам и по столбцам - очень близки
- Аналогичная ситуация на графике эффективности. на 5 процессах она падает до 65% на блоках и до 35% на 10 процессах. Строки и столбцы при этом очень хороши, эффективность на уровне 95% при 3, 5, 7 процессах. На 10 же уже видим серьезное падение до 0.65.
